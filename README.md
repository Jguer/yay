...
```sh
sudo pacman -S --needed git base-devel go less
...
```sh
sudo pacman -S --needed git base-devel go less && git clone https://aur.archlinux.org/yay.git && cd yay && makepkg -si
```
...
```sh
pacman -S --needed git base-devel go less
...
```sh
pacman -S --needed git base-devel go less && git clone https://aur.archlinux.org/yay-bin.git && cd yay-bin && makepkg -si
```
