...
func TestGrapher_GraphSyncPkgAndUpgrade(t *testing.T) {
	...
	grapher := NewGrapher(mockDb, &mockaur.MockAUR{}, false, false, false, false, false, false, logger)
...
func TestGrapher_GraphSyncGroupAndValidateNodeInfo(t *testing.T) {
	...
	grapher := NewGrapher(&mock.DBExecutor{}, &mockaur.MockAUR{}, false, false, false, false, false, false, text.NewLogger(io.Discard, io.Discard, strings.NewReader(""), true, "test"))
...
func TestProvideMenuAndMakeAURPKGFromSrcinfo(t *testing.T) {
	...
	grapher := NewGrapher(&mock.DBExecutor{}, &mockaur.MockAUR{}, false, true, false, false, false, false, text.NewLogger(io.Discard, io.Discard, strings.NewReader(""), true, "test"))
	opts := []aur.Pkg{
	...
	grapherNoConfirm := NewGrapher(&mock.DBExecutor{}, &mockaur.MockAUR{}, false, false, false, false, false, false,
